...
<!-- Content Wrapper. Contains page content -->
  ...
  <input type="text" class="form-control" id="email" name="email" placeholder="User Email" value="@if (old('email')){{old('email')}}@else{{$user->email}}@endif">
                </div>
